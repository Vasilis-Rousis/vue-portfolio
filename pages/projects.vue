...
const projects = [
  {
    ...
    longDescription: 'This project involved creating a comprehensive e-commerce solution from scratch. It includes user authentication, product catalog, shopping cart, payment integration, and admin dashboard. Built with Vue 3, Nuxt.js, Node.js, and MongoDB.',
  ...
  },
  {
    ...
    longDescription: 'A powerful task management application designed to boost productivity. Features include task categories, due dates, drag-and-drop organization, progress tracking, and data visualization. Built with Vue.js, Firebase, and Tailwind CSS.',
  ...
  },
  {
    ...
    longDescription: 'An interactive weather dashboard that provides real-time weather data and forecasts. Features include location search, interactive charts, historical data comparison, and severe weather alerts. Built with Vue.js, Chart.js, and a Weather API.',
  ...
  },
  {
    ...
    longDescription: 'A comprehensive fitness tracking mobile application that helps users monitor their workouts, nutrition, and overall health. Features include workout plans, progress tracking, nutrition logging, and personalized recommendations.',
  ...
  },
  {
    ...
    longDescription: 'A sophisticated financial dashboard providing comprehensive analytics and visualization tools for personal and business finance management. Includes expense tracking, budget planning, investment monitoring, and financial goal setting.',
  ...
  },
  {
    ...
    longDescription: 'A complete brand identity design project for a local cafe, including logo design, color palette, typography selection, brand guidelines, packaging design, and marketing materials. Created using Adobe Creative Suite.',
